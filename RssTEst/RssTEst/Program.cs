        ...
        private static void Main(string[] args)
        {
            using (var ctx = new RssContext())
            {
                try
                {
                    ...
                    //temp.Add(new Object[] { "", "orben", 3600, "http://feeds.feedburner.com/KorbensBlog-UpgradeYourMind?format=xml", "2014-02-09 16:38:27.313" });
                    //temp.Add(new Object[] { "", "DealLabs.com - Deals nouveaux", 120, "http://www.dealabs.com/rss/new.xml", "2014-02-09 16:38:27.313" });
                    //temp.Add(new Object[] { "", "This is why i'm broke", 3600, "http://feeds.feedburner.com/ThisIsWhyImBroke?format=xml", "2014-02-09 16:38:27.313" });
                    //temp.Add(new Object[] { "", "The big Picture", 43200, "http://feeds.boston.com/boston/bigpicture/index", "2014-02-09 16:38:27.313" });
                    //temp.Add(new Object[] { "Rss10FeedFormatter", "OatMeal", 21600, "http://feeds.feedburner.com/oatmealfeed?format=xml", "2014-02-09 16:38:27.313" });
                    ...
                    //temp.Add(new Object[] { "Rss10FeedFormatter", "Steam", 600, "http://store.steampowered.com/feeds/news.xml", "2014-02-09 16:38:27.313" });
                    //temp.Add(new Object[] { "", "V-inc", 3600, "http://widget.stagram.com/rss/n/vinc_fr/", "2014-02-09 16:38:27.313" });
                    //temp.Add(new Object[] { "", "google actu", 45,  "http://news.google.fr/news?pz=1&cf=all&ned=fr&hl=fr&output=rss", "2014-02-09 16:38:27.313" });
                    //temp.Add(new Object[] { "", "iberation", 120, "http://liberation.fr.feedsportal.com/c/32268/fe.ed/rss.liberation.fr/rss/9/", "2014-02-09 16:38:27.313" });
                    //temp.Add(new Object[] { "", "Figaro", 120, "http://feeds.lefigaro.fr/c/32266/f/438191/index.rss", "2014-02-09 16:38:27.313" });
                    //temp.Add(new Object[] { "", "Nouvel Obs", 120, "http://rss.nouvelobs.com/c/32262/fe.ed/tempsreel.nouvelobs.com/rss.xml", "2014-02-09 16:38:27.313" });
                    //temp.Add(new Object[] { "", "Rue 89", 600, "http://rue89.feedsportal.com/c/33822/f/608959/index.rss", "2014-02-09 16:38:27.313" });
                    ...
                    //temp.Add(new Object[] { "Rss20FeedFormatter", "Monsieur le hien", 21600, "http://www.monsieur-le-chien.fr/rss.php", "2014-02-09 16:38:27.313" });
                    ...
                    //temp.Add(new Object[] { "", "NY Times - International", 120, "http://rss.nytimes.com/services/xml/rss/nyt/InternationalHome.xml", "2014-02-09 16:38:27.313" });
